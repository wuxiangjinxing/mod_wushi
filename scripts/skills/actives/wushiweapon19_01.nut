this.wushiweapon19_01 <- this.inherit("scripts/skills/skill", {
	m = {
		SoundOnLightning = [
			"sounds/combat/wushiweapon19_01.wav"
		]
	},
	function create()
	{
		this.m.ID = "actives.wushiweapon19_01";
		this.m.Name = "Roaring fire!!!";
		this.m.Description = "Roaring fire!!!";
		this.m.KilledString = "Carved up";
		this.m.Icon = "skills/wushiweapon24_01.png";
		this.m.IconDisabled = "skills/wushiweapon24_01_sw.png";
		this.m.Overlay = "wushiweapon24_01";
		this.m.SoundOnUse = [
		...
		ret.extend([
			{
				...
				text = "Deals extra fire damage to nearby enemies."
			},
			{
				id = 7,
				type = "text",
