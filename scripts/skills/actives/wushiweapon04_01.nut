this.wushiweapon04_01 <- this.inherit("scripts/skills/skill", {
	m = {
	...
	function create()
	{
		this.m.ID = "actives.wushiweapon04_01";
		...
		this.m.Icon = "skills/wushiweapon04_01.png";
		this.m.IconDisabled = "skills/wushiweapon04_01_sw.png";
		this.m.Overlay = "wushiweapon04_01";
		this.m.SoundOnUse = [
			"sounds/combat/wushiweapon03_01.wav"
		];
		this.m.SoundOnHit = [
